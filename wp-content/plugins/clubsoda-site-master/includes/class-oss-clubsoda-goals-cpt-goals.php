 ...
 */
class OSS_ClubSoda_Goals_Cpt_Goals {
	...
	public function name() {
		...
		$name = 'clubsoda_goals'; // Post type name. Max of 20 characters. Uppercase and spaces not allowed.
	...
	public function config() {
        ...
        */
        $config['slug'] = 'goal'; // string (defaults to the post type name)
