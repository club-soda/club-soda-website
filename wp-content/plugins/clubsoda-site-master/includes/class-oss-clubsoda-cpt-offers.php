...
class OSS_ClubSoda_Cpt_Offers {
	...
	public function name() {
		...
		$name = 'clubsoda_offers'; // Post type name. Max of 20 characters. Uppercase and spaces not allowed.
	...
	public function labels() {
		...
		$label_general = 'Support Offers';
		$label_singular = 'Support Offer';
	...
	public function config() {
        ...
        */
        $config['slug'] = 'support'; // string (defaults to the post type name)
        ...
        $config['menu_icon'] = 'dashicons-carrot';
         ...
         */
        $config['has_archive'] = 'support'; // bool|string (defaults to FALSE)
         ...
         */
        $config['query_var'] = 'offers'; // bool|string (defaults to TRUE - post type name)
