...
class OSS_ClubSoda_Cpt_Events {
	...
	public function name() {
		...
		$name = 'clubsoda_events'; // Post type name. Max of 20 characters. Uppercase and spaces not allowed.
	...
	public function labels() {
		...
		$label_general = 'Events';
		$label_singular = 'Event';

		$label_featured_image = 'Event Logo';
	...
	public function config() {
         ...
         */
        $config['description'] = __( 'Events organised or promoted by Club Soda.', 'plugin-text-domain' ); // string
         ...
         */
        $config['has_archive'] = 'events'; // bool|string (defaults to FALSE)
        ...
        */
        $config['slug'] = 'events'; // string (defaults to the post type name)
        ...
        */
         ...
         */
        $config['query_var'] = 'events'; // bool|string (defaults to TRUE - post type name)
