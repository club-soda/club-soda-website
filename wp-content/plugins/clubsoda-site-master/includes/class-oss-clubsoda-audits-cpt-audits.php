 ...
 */
class OSS_ClubSoda_Audits_Cpt_Audits {
	...
	public function name() {
		...
		$name = 'clubsoda_audits'; // Post type name. Max of 20 characters. Uppercase and spaces not allowed.
	...
	public function labels() {
		...
		$label_general = 'Audits';
		$label_singular = 'Audit';
	...
	public function config() {
         ...
         */
        $config['exclude_from_search'] = true; // bool (defaults to opposite of 'public')

        /**
         * Whether queries can be performed on the front end as part of parse_request(). 
         */
        $config['publicly_queryable'] = false; // bool (defaults to 'public').
         ...
         */
        $config['show_ui'] = false; // bool (defaults to 'public')

        /**
         * Whether to show post type in the admin menu. 'show_ui' must be true for this to work. 
         */
        $config['show_in_menu'] = false; // bool (defaults to 'show_ui')
         ...
         */
        $config['show_in_admin_bar'] = false; // bool (defaults to 'show_in_menu')
         ...
         */
        $config['has_archive'] = false; // bool|string (defaults to FALSE)
        ...
        */
        $config['rewrite'] = false; // bool (defaults to the 'has_archive' argument)

       /**
        * The slug to use for individual posts of this type. 
        */
        $config['slug'] = 'audit'; // string (defaults to the post type name)
        ...
        */
        $config['feeds'] = false; // bool (defaults to the 'has_archive' argument)
         ...
         */
        $config['delete_with_user'] = true; // bool (defaults to TRUE if the post type supports 'author')


		/**
         * What WordPress features the post type supports. 
         */
		$config['supports_standard'] = array('title','author');
