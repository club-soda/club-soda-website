...
<div id="col-3" class="">
	<div id="primary" class="content-area">
		<section id="content" class="row site-content" role="main">

			<?php if ( have_posts() ) : ?>

					<?php oystershell_content_nav( 'nav-above' ); ?>

				<header class="medium-10 medium-centered column page-header">
					<h1 class="page-title">
						<?php
							if ( is_category() ) {
			...
			<?php else : ?>
				...
				<div id="post-0" class="medium-10 large-7 medium-centered column post no-results not-found">
