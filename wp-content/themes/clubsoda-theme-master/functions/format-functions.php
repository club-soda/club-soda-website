 ...
 */
 ...
 function oystershell_content_nav_links_post() { ?>
 	...
 	<nav role="navigation" class="medium-10 large-7 medium-centered column site-navigation post-navigation">
 		<h1 class="assistive-text"><?php _e( 'Content navigation', 'oystershell' ); ?></h1>
 		<?php previous_post_link( '<div class="nav-previous">%link</div>', '<span class="meta-nav">' . _x( '&larr;', 'Previous post link', 'oystershell' ) . '</span> Previous' ); ?>
 		<?php next_post_link( '<div class="nav-next">%link</div>', 'Next <span class="meta-nav">' . _x( '&rarr;', 'Next post link', 'oystershell' ) . '</span>' ); ?>
 	</nav>
 ...
 function oystershell_content_nav_links_paging() { ?>
 	...
 	<nav role="navigation" class="medium-10 large-8 medium-centered column site-navigation paging-navigation">
 		<h1 class="assistive-text"><?php _e( 'Content navigation', 'oystershell' ); ?></h1>
 ...
 function oystershell_content_nav_links_numeric($before = '', $after = '') {
  ...
  echo '<nav role="navigation" class="medium-10 large-7 medium-centered column site-navigation paging-navigation"><h1 class="assistive-text">' .  __( 'Content navigation', 'oystershell' ) . '</h1>';
 ...
 */
 function oystershell_tags_n_cats( $before = '', $after = '' ) {
 	...
 	if ( ! oystershell_categorized_blog() ) {
 		...
 		if ( '' != $tag_list ) {
 			$meta_text = __( '%1$s<i class="fa fa-tags" aria-hidden="true"></i> %3$s%4$s', 'oystershell' );
 		} else {
 		...
 		if ( '' != $tag_list ) {
 			$meta_text = __( '%1$s<i class="fa fa-th-list" aria-hidden="true"></i> %2$s<span class="sep"> &middot; </span> <i class="fa fa-tags" aria-hidden="true"></i> %3$s%4$s', 'oystershell' );
 		} else {
 			$meta_text = __( '%1$s<i class="fa fa-th-list" aria-hidden="true"></i> %2$s%4$s', 'oystershell' );
 		}
