...
function oystershell_fonts_url() {
	...
	if ( 'off' !== _x( 'on', 'Roboto Slab font: on or off', 'oystershell' ) ) {
		$fonts[] = 'Roboto+Slab';
	}
  if ( 'off' !== _x( 'on', 'Open Sans font: on or off', 'oystershell' ) ) {
		$fonts[] = 'Open+Sans';
	}
  if ( 'off' !== _x( 'on', 'Open Sans Condensed font: on or off', 'oystershell' ) ) {
		$fonts[] = 'Open+Sans+Condensed:300';
	}
